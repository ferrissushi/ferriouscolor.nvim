local bufferline = require 'ferriouscolor.integrations.bufferline'
local cmp = require 'ferriouscolor.integrations.cmp'
local colorscheme = require 'ferriouscolor.colorscheme'
local config = require 'ferriouscolor.config'
local utils = require 'ferriouscolor.utils'
local theme = {}
...
function theme.colorscheme()
  if vim.version().minor < 8 then
    vim.notify(
      'Neovim 0.8+ is required for ferriouscolor colorscheme',
  ...
  vim.g.colors_name = 'ferriouscolor'
