...
if vim.o.background == "light" then
	...
	colorscheme.editorBackground = config.transparent and "none" or "#010105"
	colorscheme.sidebarBackground = "#020b1b"
  colorscheme.barColor = "#0d1c03"
	colorscheme.popupBackground = "#1b0f06"
	colorscheme.floatingWindowBackground = "#1b0f06"
	colorscheme.menuOptionBackground = "#1b0f06"
	...
	colorscheme.windowBorder = "#cb5000"
	colorscheme.focusedBorder = "#df5506"
	colorscheme.emphasizedBorder = "#df5506"

	colorscheme.syntaxError = "#ff0000"
